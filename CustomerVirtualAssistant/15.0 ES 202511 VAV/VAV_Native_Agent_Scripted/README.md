...
* User needs to select Webex CCAI from dropdown and then as Scripted and add mandatory desired event name to start event flow in the setting attribute of VirtualAgentVoice 
...
* The file attached contains:
   * VAV_Native_Agent_Scripted -  AI Agent with Fallback as well as Custom Exit and Re-entry to same or diff AI Agent
